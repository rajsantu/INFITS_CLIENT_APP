...
public class Section5Q5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "http://192.168.1.100/myproject/infits/section5Q5red.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
            ...
            try {
                ...
                else if(answer.equals("Don`t Know")) dk.performClick();
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (allergies.equals(""))
                    ...
                    String url = "http://192.168.1.100/myproject/infits/section5Q5up.php";
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            Log.e("Checking", "Checking");
                            dataVol.put("clientuserID", DataFromDatabase.clientuserID);
                            dataVol.put("newAnswer", allergies);

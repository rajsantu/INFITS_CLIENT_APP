...
public class Subscription2 extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buy = findViewById(R.id.buy_4000);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(Subscription2.this, object);
    ...
    public void onPaymentSuccess(String s) {
        ...
        Intent intent = new Intent(Subscription2.this, OverviewFragment.class);

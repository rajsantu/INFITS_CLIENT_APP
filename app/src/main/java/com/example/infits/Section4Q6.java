...
public class Section4Q6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "http://192.168.1.100/myproject/infits/section4Q6red.php";
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (skipping.equals(""))
                    ...
                    String url = "http://192.168.1.100/myproject/infits/section4Q6up.php";
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            Log.e("Checking", "Checking");
                            dataVol.put("clientuserID", DataFromDatabase.clientuserID);
                            dataVol.put("newAnswer", skipping);

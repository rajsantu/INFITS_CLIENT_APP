...
public class DataFromDatabase {
    ...
    // public static String //dietitianuserID,clientuserID,password,name,email,mobile,location,age,gender,w//eight,plan,height,dietitian_id,client_id,dateandtime,verification;
    //Mustafa Chanes

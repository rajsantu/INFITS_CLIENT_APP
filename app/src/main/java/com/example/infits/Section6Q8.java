...
public class Section6Q8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "http://192.168.1.100/myproject/infits/section6Q8red.php";
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fruits.equals(""))
                    ...
                    String url = "http://192.168.1.100/myproject/infits/section6Q8up.php";
